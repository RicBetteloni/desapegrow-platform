  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-50 to-blue-50">
      <div className="container mx-auto p-6">
        ...
        <div className="mb-8">
          <div className="mb-4">
            <h1 className="text-2xl md:text-3xl font-bold mb-2">📢 Meus Anúncios</h1>
            <p className="text-gray-600">Gerencie seus produtos à venda</p>
          </div>
          <div className="flex flex-col sm:flex-row gap-3">
            <Link href="/vendedor/produtos/novo" className="flex-1 sm:flex-initial">
              <Button size="lg" className="w-full sm:w-auto">
                <Plus className="w-5 h-5 mr-2" />
                Novo Produto
              </Button>
            </Link>
            <Link href="/vendedor/pedidos" className="flex-1 sm:flex-initial">
